...
public class Mage extends Character {
    ...
    public void attack(Destructible target){
        ...
        if (mana - 10 > 0){
            ...
            System.out.println(name+" ("+role+") has "+mana+"/"+maxMana+" not enough mana for the magic missile.");
            return;
        }
        ...
        if (target instanceof Character){
            ...
            System.out.println("✨ "+name+" ("+role+") cast a Magic missile on "+character.getName()+" with "+weapon.getName());
        }else {
            System.out.println("✨ "+name+" ("+role+") cast a Magic missile on Target!");
        }
